...
if(GUARDARPLOT) {ggsave("Plots/GUS_Pred.tiff", plot =  GUSPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/Kda_t_ratioPredPlot_Pred.tiff", plot =  Kda_t_ratioPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/KOCaPredPlot_Pred.tiff", plot =  KOCaPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/KOCgPredPlot_Pred.tiff", plot =  KOCgPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(VERPLOT) GUSPredPlot
if(GUARDARPLOT) {ggsave("Plots/GUSPredPlot_Pred.tiff", plot =  GUSPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/CATKOCaPredPlot_Pred.tiff", plot =  CATKOCaPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/CATKOCgPredPlot_Pred.tiff", plot =  CATKOCgPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
...
if(GUARDARPLOT) {ggsave("Plots/CATGUSPredPlot_Pred.tiff", plot =  CATGUSPredPlot, device = "tiff", width = ANCHO, height = ALTO, units = "cm")}
