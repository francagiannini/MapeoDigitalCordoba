...
<qgis maxScale="1000" minScale="1e+8" version="3.2.2-Bonn" hasScaleBasedVisibilityFlag="0">
  <pipe>
    <rasterrenderer classificationMin="0" band="1" type="singlebandpseudocolor" opacity="1" classificationMax="21" alphaBand="-1">
      <rasterTransparency/>
      <minMaxOrigin>
        <limits>None</limits>
      ...
      <rastershader>
        <colorrampshader colorRampType="INTERPOLATED" classificationMode="1" clip="0">
          ...
          <item label="Cultivos anuales de secano" value="15" color="#ccce36" alpha="255"/>
          <item label="Cultivos anuales irrigados" value="16" color="#f7fa41" alpha="255"/>
          <item label="Pasturas implantadas" value="17" color="#07eb98" alpha="255"/>
          <item label="Pasturas naturales manejadas" value="18" color="#adde8f" alpha="255"/>
          <item label="Plantaciones forestales maderables" value="19" color="#84371d" alpha="255"/>
          <item label="Plantaciones perennes (frutales) de secano" value="20" color="#a8583d" alpha="255"/>
          <item label="Plantaciones perennes (frutales) irrigadas" value="21" color="#b07a67" alpha="255"/>
        </colorrampshader>
      </rastershader>
    </rasterrenderer>
